        ...
        if ($stmt->rowCount() > 0) {
            ...
            <div class="container">
                ...
                <form method="POST" action="RoomDetailUpdateController.php">
                    ...
                    <div class="row justify-content-center">
                        <div class="form-group col-md-4 col-md-offset-1 align-center">
                            <label for="room booked">Room Booked:</label>
                    ...
                    <div class="row justify-content-center">
                        <div class="form-group col-md-4 col-md-offset-1 align-center">
                            <label for="room featured">Room Featured:</label>
            ...
            <div class="row justify-content-center">
                <div class="form-group col-md-4 col-md-offset-1 align-center">
                    ...
                    <input type="date" class="form-control" name="checkin" id="checkin" value="<?php echo $row['check_in_date'] ?>"
            ...
            <div class="row justify-content-center">
                <div class="form-group col-md-4 col-md-offset-1 align-center">
                    ...
                    <input type="date" class="form-control" name="checkout" id="checkout"
                        value="<?php echo $row['check_out_date']; ?>" required>
                </div>

            </div>
            <div class="row justify-content-center">
                <div class="form-group col-md-4 col-md-offset-1 align-center">
                    <label for="maxNoOfDate">Max no of persons:</label>
